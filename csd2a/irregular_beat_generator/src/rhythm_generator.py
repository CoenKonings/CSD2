...
def generate_snare_pattern(sequencer):
    """
    ...
    track = sequencer.add_track(16, audio_file, "snare")
...
def generate_kick_pattern(sequencer):
    """
...
def main():
    ...
    generate_kick_pattern(sequencer)
    generate_snare_pattern(sequencer)
    generate_hat_pattern(sequencer)
    sequencer.start()
